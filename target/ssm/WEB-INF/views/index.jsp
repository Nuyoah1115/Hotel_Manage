    ...
    <div class="main" id="">
        ...
        <div class="right">
            <blockquote class="layui-elem-quote">
                    <h2>欢迎登陆海天大酒店后台管理系统</h2>

                    <marquee  vspace="15px">
                        <font face="宋体" size="5px" color="fuchsia" >欢迎入住海天大酒店！祝您心情愉快~~</font>
                    </marquee>
                <%-- 显示系统当前时间--%>
                <div id="datetime">
                    <script>
                ...
                <div class="layui-col-md4">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="height: 250px;">
                            <ul>
                                <li>该系统后端基于SSM框架，前端基于layui框架</li>
                                <li>风格简洁简单,中小型企业首选</li>
                                <li>可以通过点击下面按钮跳转到相应的功能</li>
                                <li><a href="/guests/list" target="_blank" class="layui-btn layui-btn-radius layui-btn-normal">住&nbsp;客&nbsp;信&nbsp;息</a></li>
                                <li><a href="/home/list" target="_blank" class="layui-btn layui-btn-radius">房&nbsp;间&nbsp;信&nbsp;息</a></li>
                                <li><a href="/vip/list" target="_blank" class="layui-btn layui-btn-radius layui-btn-warm">会&nbsp;员&nbsp;信&nbsp;息</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
